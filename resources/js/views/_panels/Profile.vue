            ...
            <div class="col-md-4 col-xl-3">
                <div class="card mb-3">
                    ...
                    <div class="card-body text-center">
                        ...
                        <h5 class="card-title mb-0">{{ state.profile.fullname }}</h5>
                        <div class="text-muted mb-2">{{ state.currentRoles }}</div>
                        <div>
                ...
                <div class="card">
                    ...
                    <div class="card-body h-100">
                        ...
                        <div class="d-flex align-items-start">
                            <img :src="ava5" width="36" height="36" class="rounded-circle me-2" alt="Vanessa Tucker">
                        ...
                        <hr>
                        <div class="d-flex align-items-start">
                            <img :src="ava" width="36" height="36" class="rounded-circle me-2" alt="Charles Hall">
                            <div class="flex-grow-1">
                        ...
                        <hr>
                        <div class="d-flex align-items-start">
                            <img :src="ava4" width="36" height="36" class="rounded-circle me-2" alt="Christina Mason">
                            <div class="flex-grow-1">
                        ...
                        <hr>
                        <div class="d-flex align-items-start">
                            <img :src="ava2" width="36" height="36" class="rounded-circle me-2" alt="William Harris">
                            <div class="flex-grow-1">
                                ...
                                <div class="row g-0 mt-1">
                                    <div class="col-6 col-md-4 col-lg-4 col-xl-3">
                                        <img :src="unsplash1" class="img-fluid pe-2" alt="Unsplash">
                                    </div>
                                    <div class="col-6 col-md-4 col-lg-4 col-xl-3">
                                        <img :src="unsplash2" class="img-fluid pe-2" alt="Unsplash">
                                    </div>
                                </div>
...
<script setup>
    ...
    const state = reactive({
        profile: authStore.authUser,
        currentRoles: authStore.roleUser.join(', ')
    });

    console.log(authStore.roleUser);
